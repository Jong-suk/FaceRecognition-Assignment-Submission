...
image_train = face_recognition.load_image_file('chrisevans.jpg')
...
image_test = face_recognition.load_image_file('Chris-Evans.jpg')
...
if results:
    ...
    (0,255,0),
    2)
    cv2.putText(image_train, f"Chris Evans",
    (60,60),
    cv2.FONT_HERSHEY_DUPLEX,
    1,
    (0,255,0),
    1)
    cv2.imshow("Chris Evans", image_train)
else:
    print("Face not recognized. Result was {results} and distance was {dst}")
